...
DROP TABLE IF EXISTS PUBLIC.FILM_MARKS CASCADE;
...
(
    ...
    MARK    FLOAT  NOT NULL,
    UNIQUE (FILM_ID, USER_ID),
    CONSTRAINT FK_FILM_MARKS_FILM_ID FOREIGN KEY (FILM_ID) REFERENCES PUBLIC.FILMS (FILM_ID) ON DELETE CASCADE,
    CONSTRAINT FK_FILM_MARKS_USER_ID FOREIGN KEY (USER_ID) REFERENCES PUBLIC.USERS (USER_ID) ON DELETE CASCADE
);
